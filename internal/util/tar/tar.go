...
// CreateTarGzWithOptions creates a tar archive with filtering and flattening options (v0.7.4)
...
// Logic matches Python PUR v0.7.4:
...
// GetTarSize returns the size of a tar file in bytes
func GetTarSize(tarPath string) (int64, error) {
