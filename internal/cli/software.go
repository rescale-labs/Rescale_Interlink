...
Examples:
  ...
  rescale-int software list --json`,
	...
	cmd.Flags().StringVar(&search, "search", "", "Search for software by code, name, or description")
	cmd.Flags().BoolVar(&outputJSON, "json", false, "Output as JSON")
	cmd.Flags().BoolVar(&showVersions, "versions", false, "Show available versions for each software")
