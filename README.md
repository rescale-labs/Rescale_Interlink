...
![Status](https://img.shields.io/badge/status-v4.9.0-green)
...
|----------|---------|----------|
| macOS (Apple Silicon) | `rescale-interlink-v4.9.0-macos-arm64.tar.gz` | `rescale-int-gui.app` |
| Linux (x64) | `rescale-interlink-v4.9.0-linux-amd64.tar.gz` | `rescale-int-gui.AppImage` + `rescale-int` CLI |
| Windows (x64) | `rescale-interlink-v4.9.0-win_amd64.zip` | `rescale-int-gui.exe` + `rescale-int.exe` |
| Windows Installer | `rescale-interlink-v4.9.0-win_amd64.msi` | Full installer with Start Menu integration |

**macOS:**
```bash
# Extract and move app to Applications
tar -xzf rescale-interlink-v4.9.0-macos-arm64.tar.gz
...
tar -xzf rescale-interlink-v4.9.0-linux-amd64.tar.gz
...
```powershell
# Unzip and run GUI:
Expand-Archive rescale-interlink-v4.9.0-win_amd64.zip
.\rescale-int-gui.exe
