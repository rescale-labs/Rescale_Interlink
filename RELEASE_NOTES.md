...
- `CLAUDE.md` - Removed machine-specific paths, made token file references portable
...
Updated `DOCUMENTATION_SUMMARY.md` to include CLAUDE.md as the 11th official document and removed reference to non-existent `bin/README.md`.
