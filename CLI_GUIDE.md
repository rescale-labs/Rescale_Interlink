...
Complete command-line interface reference for `rescale-int` v4.7.2.
...
This guide is for `rescale-int` v4.7.2 (February 21, 2026)

View version:
```bash
rescale-int --version
# Output: rescale-int version v4.7.2 (2026-02-21) [FIPS 140-3]
```
