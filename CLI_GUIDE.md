...
Complete command-line interface reference for `rescale-int` v4.7.3.
...
This guide is for `rescale-int` v4.7.3 (February 22, 2026)

View version:
```bash
rescale-int --version
# Output: rescale-int version v4.7.3 (2026-02-22) [FIPS 140-3]
```
