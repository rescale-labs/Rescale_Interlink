...
Complete command-line interface reference for `rescale-int` v3.2.0.
...
This guide is for `rescale-int` v3.2.0 (November 30, 2025)

View version:
```bash
rescale-int --version
# Output: rescale-int version v3.2.0 (2025-11-30) [FIPS 140-3]
```
