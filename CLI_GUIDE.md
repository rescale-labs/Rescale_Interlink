...
Complete command-line interface reference for `rescale-int` v4.3.6.
...
[daemon]
enabled = true
download_folder = /Users/pklein/Downloads/rescale-jobs
...
```bash
rescale-int daemon config path
# Output: /Users/pklein/.config/rescale/daemon.conf
```
...
```bash
# Set download folder
rescale-int daemon config set daemon.download_folder /Users/pklein/Downloads/rescale-jobs
...
This guide is for `rescale-int` v4.3.6 (January 14, 2026)

View version:
```bash
rescale-int --version
# Output: rescale-int version v4.3.6 (2026-01-14) [FIPS 140-3]
```
