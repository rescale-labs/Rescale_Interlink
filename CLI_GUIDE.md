...
Complete command-line interface reference for `rescale-int` v4.2.1.
...
This guide is for `rescale-int` v4.2.1 (January 9, 2026)

View version:
```bash
rescale-int --version
# Output: rescale-int version v4.2.1 (2026-01-09) [FIPS 140-3]
```
